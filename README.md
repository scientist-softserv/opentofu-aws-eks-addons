...
```hcl
module "eks_addons" {
  source                              = "https://github.com/atmosly/opentofu-aws-eks-addons.git"
  name                                = "skaf"
...
## IAM Permissions
The required IAM permissions to create resources from this module can be found [here](https://github.com/atmosly/opentofu-aws-eks-addons.git/blob/main/IAM.md)
...
To report an issue with a project:
  ...
  1. Check the repository's [issue tracker](https://github.com/atmosly/opentofu-aws-eks-addons.git/issues) on GitHub
...
To support a GitHub project by liking it, you can follow these steps:
  ...
  1. Visit the repository: Navigate to the [GitHub repository](https://github.com/atmosly/opentofu-aws-eks-addons.git).
